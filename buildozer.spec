...
source.exclude_dirs = tests, bin, venv, .venv, cache, python-for-android, .kivy, examples
...
requirements = python3,kivy==master,kvdroid,androidstorage4kivy,sjfirebaseai,sjfirebase,simplejnius
...
#android.presplash_color = #FFFAD3
