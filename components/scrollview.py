...
LEFT = 1  # finger and content move right (scroll bar moves left) to see the far left of the entire content
RIGHT = 2  # finger and content move left (scroll bar moves right) to see the far right of the entire content
DOWN = 3  # finger and content move up (scroll bar moves down) to see the very bottom of the entire content
UP = 4  # finger and content move down (scroll bar moves up) to see the very top of the entire content
...
class RealRecycleView(RecycleView):
    ...
    track_scroll_movement = BooleanProperty(False)
